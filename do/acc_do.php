...
$(document).ready(function(){
	...
	function isiTabelDetail(idDO) {
		$.ajax({
			...
			method: "POST",
			dataType: "JSON",
			data: {"aksi" : "<?php echo e_url('do/do_aux.php'); ?>", "title" : "D.O.", "apa" : "acc-daftar-detail-do", "idDO" : idDO },
	...
	$("#tabel-do tbody").on("click",".btn-acc-do", function(ev){
		ev.preventDefault();
		var idDO = $(this).data("id");
		if (confirm("Apakah benar akan di acc ?")) {
			$.ajax({
				...
				cache: false,
				dataType: "JSON",
				data: {"aksi" : "<?php echo e_url('do/do_aux.php'); ?>", "title" : "D.O.", "apa" : "simpan-acc-do", "idDO" : idDO},
	...
	$("#tabel-do tbody").on("click",".btn-tolak-do", function(ev){
		ev.preventDefault();
		var idDO = $(this).data("id");
		if (confirm("Apakah benar akan di tolak ?")) {
			$.ajax({
				...
				cache: false,
				dataType: "JSON",
				data: {"aksi" : "<?php echo e_url('do/do_aux.php'); ?>", "title" : "D.O.", "apa" : "simpan-tolak-do", "idDO" : idDO},
				success: function(eve) {
					if (eve.status) {
						alert(eve.msg);
						tabeldo.ajax.reload();
	...
	function reloading(){
		...
		$.ajax({
            ...
            method: "POST",
            cache: false,
            data: {"mod" : "<?php echo e_url('do/acc_do.php'); ?>", "title" : "D.O." },
