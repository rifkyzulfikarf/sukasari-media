...
if(  isset($_POST['id']) && $_POST['id']<>"" && isset($_POST['user']) && isset($_POST['password']) && isset($_POST['password2']) && $_POST['user']<>"" && $_POST['password']<>"" && $_POST['password2']<>"" && strlen($_POST['password']) > 3 && $_POST['password'] == $_POST['password2']  ){
